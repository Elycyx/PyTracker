...
This example demonstrates how to use PyTracker to track controller pose data
in real-time. It shows the controller's position and orientation as Euler angles.
...
def main():
    """Main function for controller testing."""
    print("PyTracker Controller Test")
    print("=" * 40)
    ...
    if len(sys.argv) == 1:
        ...
        print("Usage: python -m pytracker.examples.test_controller [sample_rate]")
        return 1
